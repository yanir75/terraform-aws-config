output "aggregator_arn" {
  ...
  description = "Aggregator arn"
}

output "authorization_arns" {
  description = "Authorization arns"
...
output "regions" {
  description = "Regions which the aggregator utilize"
  value = local.regions
}
...
output "recorder_delivery_channel" {
  description = "recorder delivery channel"
